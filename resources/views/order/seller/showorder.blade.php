...
<div class="bg-gray-50 min-h-screen">
    <main class="w-full max-w-[1280px] mx-auto pt-24 px-4 sm:px-6 lg:px-8 pb-12 transition-all duration-300">
        ...
        <header class="mb-8 border-b border-[#e8dfd1] pb-6">
            <h1 class="font-['Literata'] text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Daftar Orderan Anda</h1>
            <p class="text-xs sm:text-sm text-gray-500 font-['Source_Serif_4'] italic">Pantau aliran pesanan dan kelola status pengiriman mahakarya buku Anda.</p>
        </header>
        ...
        <div class="flex flex-col gap-6 sm:gap-8">
            @forelse ($orders as $order)
                <div class="order-card bg-white border border-[#e8dfd1] rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-[0_8px_30px_rgb(122,79,55,0.06)]"
                    ...
                    <div class="p-5 sm:p-6 border-b border-gray-100 bg-[#f6f3eb]/40 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div>
                            <!-- REVISI KONDISI STATUS: Mengikuti penamaan status di database -->
                    ...
                    <div class="p-5 sm:p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 border-b border-gray-100">
                        ...
                        <div class="flex-grow text-center sm:text-left">
                            ...
                            <p class="text-xs text-gray-900 font-bold bg-gray-100 inline-block px-3 py-1 rounded-lg border border-gray-200/60">Jumlah Pembelian: {{ $order->qty ?? 1 }} Pcs</p>
                        </div>
                        ...
                        <div class="text-center sm:text-right flex flex-col items-center sm:items-end gap-1 shrink-0 bg-[#5f3822]/5 p-4 rounded-xl border border-[#5f3822]/5 w-full sm:w-auto">
                            <span class="text-[9px] font-bold tracking-wider text-gray-400 uppercase">Total Pendapatan</span>
            ...
            @empty
                <div class="bg-white py-20 text-center rounded-2xl border border-[#e8dfd1] shadow-sm px-4">
                    ...
                    <p class="font-['Source_Serif_4'] text-gray-500 text-sm">Tidak ada pesanan masuk yang terdeteksi.</p>
                </div>
            @endforelse
        </div>
