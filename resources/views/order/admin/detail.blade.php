...
<div class="bg-gray-50 min-h-screen">
    <main class="w-full max-w-[1280px] mx-auto pt-24 px-4 sm:px-6 lg:px-8 pb-12 transition-all duration-300">
        ...
        <div class="mb-6">
            <a href="{{ route('admin.orders') }}" class="inline-flex items-center gap-1.5 text-sm font-semibold text-[#7a4f37] hover:text-[#5f3822] transition-all">
                <span class="material-symbols-outlined text-lg">arrow_back</span> Kembali ke Semua Pesanan
            </a>
        </div>
        ...
        <header class="mb-8 border-b border-[#e8dfd1] pb-6">
            ...
            <p class="text-xs sm:text-sm text-gray-500 font-['Source_Serif_4'] italic">Informasi lengkap transaksi di platform.</p>
        </header>
        ...
        <div class="bg-white border border-[#e8dfd1] rounded-2xl overflow-hidden shadow-sm">
                ...
                <div class="flex-grow text-center sm:text-left">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 bg-gray-50/50 rounded-xl p-4 border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-[#5f3822]">{{ $order->book->seller->name ?? 'Tidak diketahui' }}</p>
                        </div>
                        <div>
                            <span class="text-[10px] font-bold tracking-wider text-gray-400 uppercase">Pembeli</span>
                            <p class="text-sm font-semibold text-[#5f3822]">{{ $order->buyer->name ?? 'Pelanggan' }}</p>
                        </div>
                    </div>
            ...
            <div class="p-5 sm:p-6 md:p-8 border-b border-gray-100 bg-white">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <span class="text-[10px] font-bold tracking-wider text-gray-400 uppercase">Total Transaksi</span>
